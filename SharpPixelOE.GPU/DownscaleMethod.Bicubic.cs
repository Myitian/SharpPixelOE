...
{
    public static Array2D<float> Bicubic(
        ...
        int patchSize)
    {
        ...
        return ImageUtils.ResizePlanar4xFP32(accelerator, stream, imgPlanarLabA, resultWidth, resultHeight, InterpolationMethod.Bicubic);
    }
}
