...
{
    public static Array2D<float> Bicubic(Array2D<float> imgPlanarLabA, int patchSize)
    {
        ...
        return ImageUtils.ResizePlanar4xFP32(imgPlanarLabA, resultWidth, resultHeight, InterpolationMethod.Bicubic);
    }
}
